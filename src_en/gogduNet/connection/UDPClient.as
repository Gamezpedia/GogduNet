package gogduNet.connection
{
	...
	/** This occurs when involuntary closed receiving because of OS, etc.<p/>
	...
	/** This occurs when received data from unpermitted target
	 ...
	 * <p/>(id:ID of connection that sent packet, dataType, dataDefinition, data)
	 */
	[Event(name="receiveData", type="gogduNet.events.DataEvent")]
	/** This occurs when received abnormal packet
	 * <p/>(id:ID of connection that sent packet, dataType:DataType.INVALID, dataDefinition:"Wrong" or "Surplus", data:ByteArray of abnormal packet)
	 */
	[Event(name="invalidPacket", type="gogduNet.events.DataEvent")]
	
	/** UDP client which communicate by base on JSON string<p/>
